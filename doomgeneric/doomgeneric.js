...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   ...
   loadPackage({"files": [{"filename": "/DOOM1.WAD", "start": 0, "end": 4196020, "audio": 0}], "remote_package_size": 4196020, "package_uuid": "84d635aa-e5bf-4ca6-aa3e-3ddf658dcd1b"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 403408,
    DYNAMIC_BASE = 5646288,
    DYNAMICTOP_PTR = 403248;
...
var INITIAL_INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 32768000;if (!Object.getOwnPropertyDescriptor(Module, 'INITIAL_MEMORY')) Object.defineProperty(Module, 'INITIAL_MEMORY', { configurable: true, get: function() { abort('Module.INITIAL_MEMORY has been replaced with plain INITIAL_INITIAL_MEMORY (the initial value can be provided on Module, but after startup the value is only looked for on a local variable of that name)') } });
...
var wasmBinaryFile = 'doomgeneric.wasm';
...
var ASM_CONSTS = {
  99339: function($0, $1) {canvas = document.getElementById('canvas'); canvas.width = $0; canvas.height = $1;},  
 99426: function($0, $1, $2) {let data = Module.HEAPU8.slice($0, $0 + $1 * $2 * 4); let context = Module['canvas'].getContext('2d'); let imageData = context.getImageData(0, 0, $1, $2); imageData.data.set(data); context.putImageData(imageData, 0, 0);}
};

function _emscripten_asm_const_iii(code, sigPtr, argbuf) {
  var args = readAsmConstArgs(sigPtr, argbuf);
  return ASM_CONSTS[code].apply(null, args);
}function setWindowTitle(title){ window.document.tile = UTF8ToString(title); }



// STATICTOP = STATIC_BASE + 402384;
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "__sys_fcntl64": ___sys_fcntl64, "__sys_ioctl": ___sys_ioctl, "__sys_mkdir": ___sys_mkdir, "__sys_open": ___sys_open, "__sys_rename": ___sys_rename, "__sys_rmdir": ___sys_rmdir, "__sys_unlink": ___sys_unlink, "emscripten_asm_const_iii": _emscripten_asm_const_iii, "emscripten_get_now": _emscripten_get_now, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_request_animation_frame_loop": _emscripten_request_animation_frame_loop, "emscripten_resize_heap": _emscripten_resize_heap, "emscripten_sleep": _emscripten_sleep, "exit": _exit, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "setTempRet0": _setTempRet0, "setWindowTitle": setWindowTitle, "system": _system, "table": wasmTable };
